...
// 1.8 버전 => java.time 패키지 추가

public class LocalDateEx1 {

  public static void main(String[] args) {
    Date date = new Date();
    System.out.println(date); // Thu Feb 22 14:37:29 KST 2024
    ...
    System.out.println("이 달의 며칠 " + calendar.get(Calendar.DATE));
    System.out.println("이 달의 며칠 " + calendar.get(Calendar.DAY_OF_MONTH));
    System.out.println("이 해의 며칠" + calendar.get(Calendar.DAY_OF_YEAR));
