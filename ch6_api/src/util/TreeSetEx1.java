...
// 이진검색(=탐색)트리 : 정렬, 검색, 범위 검색에 높은 성능을 보이는 자료 구조
// 모든 노드는 최대 두 개의 자식노드를 가짐
// 왼쪽 자식 노드의 값은 부모 노드의 값보다 작고 오른쪽 노드의 값은 부모 노드의 값보다 커야 한다.
// 노드의 추가, 삭제에 시간이 걸린다.
// 검색과 정렬에 유리
// 중복된 값을 저장하지 못함
public class TreeSetEx1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("50보다 바로 밑 작은 값 " + treeSet.lower(50));
    System.out.println("50보다 바로 위 큰 값 " + treeSet.higher(50));
    ...
    System.out.println("사자보다 바로 밑 작은 값 " + treeSet2.lower("사자"));
    System.out.println("사자보다 바로 위 큰 값 " + treeSet2.higher("사자"));
  }
}
